		...
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				...
				<form action="<?php echo base_url('signup');?>" method="post" class="popup-form" id="myRegister">
					...
					<input type="text" class="form-control form-white" name="name" placeholder="First Name">
					<input type="text" class="form-control form-white" name="last" placeholder="Last Name">
                    <input type="email" id="email-input" onkeyup="checkemail(this.value);" class="form-control form-white" name="email" placeholder="Email">
                    <span id="name_status"></span>
                    <input type="text" class="form-control form-white" name="mobile" placeholder="Mobile No">
